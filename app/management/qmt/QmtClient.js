          ...
          <div className="overflow-x-auto rounded-lg border border-pm-border bg-pm-surface">
            <table className="w-full text-[12px]">
              <thead className="text-left text-[10px] uppercase tracking-[0.05em] text-pm-text-3">
                ...
                <tr className="border-b border-pm-border bg-pm-bg/50">
                  <SortableTh onClick={() => toggleSort('date')} active={sortKey === 'date'} dir={sortDir}>Date</SortableTh>
                  <SortableTh onClick={() => toggleSort('jobNumber')} active={sortKey === 'jobNumber'} dir={sortDir}>Job #</SortableTh>
                  <SortableTh onClick={() => toggleSort('customer')} active={sortKey === 'customer'} dir={sortDir}>Customer</SortableTh>
                  <SortableTh onClick={() => toggleSort('jobType')} active={sortKey === 'jobType'} dir={sortDir}>Type</SortableTh>
                  <SortableTh onClick={() => toggleSort('status')} active={sortKey === 'status'} dir={sortDir}>Status</SortableTh>
                  <SortableTh onClick={() => toggleSort('estimated.totalRevenue')} active={sortKey === 'estimated.totalRevenue'} dir={sortDir} align="right">Revenue</SortableTh>
                  <SortableTh onClick={() => toggleSort('estimated.marginIncLabour')} active={sortKey === 'estimated.marginIncLabour'} dir={sortDir} align="right">M%</SortableTh>
                  <SortableTh onClick={() => toggleSort('actual.totalRevenue')} active={sortKey === 'actual.totalRevenue'} dir={sortDir} align="right">Revenue</SortableTh>
                  <SortableTh onClick={() => toggleSort('actual.marginIncLabour')} active={sortKey === 'actual.marginIncLabour'} dir={sortDir} align="right">M%</SortableTh>
